<?php
require dirname(__DIR__,1).'\classes\JwtHandler.php';
class Auth extends JwtHandler{
    ...
    protected function fetchUser($user_id){
        try{
            $fetch_user_by_id = "SELECT `customerID`,`customerName`,`customerEmail`,`customerAddress` FROM `tb_customers` WHERE `customerID`=:id";
